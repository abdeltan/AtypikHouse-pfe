 ...
 */
final class Version20220203191643 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE attribute CHANGE title title LONGTEXT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE attribute CHANGE title title TINYINT(1) NOT NULL');
