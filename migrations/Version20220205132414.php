 ...
 */
final class Version20220205132414 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE message ADD sender_id INT DEFAULT NULL, ADD receiver_id INT DEFAULT NULL, CHANGE message message VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
