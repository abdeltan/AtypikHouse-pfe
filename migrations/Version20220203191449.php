 ...
 */
final class Version20220203191449 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE attribute (id INT AUTO_INCREMENT NOT NULL, title TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE property_type_attribute (property_type_id INT NOT NULL, attribute_id INT NOT NULL, INDEX IDX_987875EF9C81C6EB (property_type_id), INDEX IDX_987875EFB6E62EFA (attribute_id), PRIMARY KEY(property_type_id, attribute_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE property_type_attribute DROP FOREIGN KEY FK_987875EFB6E62EFA');
