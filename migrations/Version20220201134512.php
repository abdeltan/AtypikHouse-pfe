 ...
 */
final class Version20220201134512 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE property CHANGE literie literie LONGTEXT DEFAULT NULL, CHANGE sanitaire sanitaire LONGTEXT DEFAULT NULL, CHANGE includes includes LONGTEXT DEFAULT NULL, CHANGE activities activities LONGTEXT DEFAULT NULL');
    }
