 ...
 */
final class Version20220203191727 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE attribute CHANGE title title VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE attribute CHANGE title title LONGTEXT NOT NULL COLLATE `utf8mb4_unicode_ci`');
